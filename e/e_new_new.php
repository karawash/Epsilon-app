<?php
  function renderForm($content, $content_arabic ,$photo , $error)
 {
 ?>
...
{ $error = 'ERROR: Please fill in all required fields!';
  renderForm($content, $content_arabic,$photo , $error);
 }
 else
{ mysql_query("INSERT newproduct SET content='$content', content_arabic='$content_arabic',photo='$photo'")
 or die(mysql_error());

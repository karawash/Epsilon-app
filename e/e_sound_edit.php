<?php
 ...
 <div>
 <strong>program name: *</strong> <input type="text" name="content" value="<?php echo $content; ?>"/><br/>
 <strong>Link        : *<br/></strong> <textarea rows="10"cols="50"type="text" name="link" value="<?php echo $link; ?>">http://</textarea><br/>
 <p>* Required link start by <font color="red"> http://</font></p>
...
{  if (is_numeric($_POST['id']))
 ...
 {  
 mysql_query("UPDATE music SET content='$content', link='$link' WHERE id='$id'")
 or die(mysql_error()); 

...
<?php
       ...
       $result = mysql_query("SELECT * FROM scroll") 
        ...
        while($row = mysql_fetch_array( $result )) {
                ...
                echo "<tr>";
                echo '<td><a href="'.$http.'e_scroll_edit.php?id=' . $row['id'] . '">Edit</a></td>';
                echo '<td><a href="'.$http.'e_scroll_delete.php?id=' . $row['id'] . '">Delete</a></td>';
       ...
       echo "</table>";
echo '<p><a href="'.$http.'e_scroll_new.php">Add a new record</a></p>';?>
